...
export const libraryRepository = {
  ...
  createPlaylist(name: string, description = '') { const state = read(); const playlist: Playlist = { id: crypto.randomUUID(), name, description, songs: [] }; state.customPlaylists = [playlist, ...state.customPlaylists]; write(state); return state; },
